...
bad_subject_list=[2,6,11,14,16, 17, 18,20, 24,28,36,37]; % Session 1
...
for mkk=1:length(good_subj_list)
    ...
    Name_Subject_session=[Folder_name '_S1_newf'];
...
%         [ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, 1,'gui','off');
        % Rene: add just low-pass before selection of channels for interpolation
        EEG = pop_eegfiltnew(EEG, [], 35, 98, 0, [], 1);
        [ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, 1,'gui','off'); 
